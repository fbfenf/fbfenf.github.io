...
**Q: 広告を削除できますか？**  
A: 現在は無料版のみ提供されており、広告削除オプションは今後のアップデートで提供予定です。

**Q: バックアップファイルはどこに保存されますか？**  
A: 共有機能を通じて、ユーザーが希望する場所(iCloud Drive、ダウンロードなど)に保存できます。

**Q: APIキーに費用がかかりますか？**  
A: 無料AIAPIプロバイダーを選択すると、無料割当量内で使用でき、通常の学習用途では無料範囲内で使用可能です。

**Q: iPadでも使用できますか？**  
A: はい、すべてのiOSデバイス(iPhone、iPad)で使用可能です。

**Q: オフラインでも使用できますか？**  
A: スクリプト閲覧はオフラインでも可能ですが、AI分析とTTS機能にはインターネット接続が必要です。
