...
### 효과적인 학습법
1. **매일 조금씩**: 연속 학습 일수(Streak)를 유지하세요.
2. **AI 분석 활용**: 모르는 단어는 AI Explain으로 정확히 이해하세요.
3. **발음 반복**: TTS를 여러 번 들으며 발음을 익히세요.
4. **북마크 활용**: 중요한 단어는 별표로 저장하세요.
5. **블러 Focus**: 번역을 보기 전에 먼저 스스로 해석해보세요.
6. **정기 백업**: 일주일에 한 번씩 백업 파일을 생성하세요.
